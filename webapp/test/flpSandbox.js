		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoicesprueba",
									"targetURL": "#invoicespruebainvoicesprueba-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicespruebainvoicesprueba-display": {
								"semanticObject": "invoicespruebainvoicesprueba",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoicesprueba.invoicesprueba",
									"url": sap.ui.require.toUrl("invoicesprueba/invoicesprueba")
								}
							}
						}
					}
